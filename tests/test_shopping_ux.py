...
class ShoppingUxContractTests(unittest.TestCase):
    ...
    def test_shopping_action_bar_uses_cookigram_svg_icons_not_raw_glyphs(self):
        ...
        self.assertIn('<rect x="6.5" y="8" width="23" height="21" rx="4" class="icon-paper"/>', html)
        self.assertIn('<path d="M12 5v7M24 5v7" class="icon-accent"/>', html)
        self.assertIn('<path d="M11 20h7.5M16 17l4 3-4 3" class="icon-planner-arrow"/>', html)
    ...
    def test_shopping_groups_before_render_and_exports_only_items_to_buy(self):
        ...
        self.assertIn('data-parent-tristate', source)
        self.assertIn('quantity-chip', source)
        self.assertIn('consolidateShopping', source)
        self.assertIn('setIngredientAvailable', source)
        self.assertIn('isIngredientAvailable', source)
        ...
        self.assertIn('shopping-subquantities', source)
    ...
    def test_selection_css_uses_light_checkboxes_flat_groups_and_illustrated_actions(self):
        ...
        self.assertIn('.shopping-item input:indeterminate', css)
        self.assertIn('.quantity-chip', css)
        self.assertIn('.shopping-subquantities', css)
